...
router.get('/appointments', (req, res) => {
  ...
  pool.query('SELECT d.doctor_name, a.day_to_meet, a.time_to_meet, a.status FROM appointments a JOIN doctors d ON a.id_doctor = d.userId WHERE a.id_patient = ?', [patientId], (error, results) => {
    if (error) {
